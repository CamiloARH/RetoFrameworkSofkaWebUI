...
public class Helper {
    ...
    public static ContactUsFillUp generateContactUs(String language, String country, String emailDomain){
        ...
        ContactUsFillUp contactUsFillUp = new ContactUsFillUp();
        contactUsFillUp.setEmail(
                faker.name()
                        .username()
                        .concat(emailDomain)
                        .replace(SPACE_STRING, EMPTY_STRING)
        ...
        contactUsFillUp.setIdOrder(faker.bothify("####-????"));
        contactUsFillUp.setMessage(faker.superhero().descriptor());
